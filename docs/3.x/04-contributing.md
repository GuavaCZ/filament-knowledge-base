...
Before you open anything, please read the [contribution guide](https://github.com/GuavaCZ/filament-knowledge-base/blob/main/.github/CONTRIBUTING.md) in the repository.

## Reporting a bug

Bugs belong in the [issue tracker](https://github.com/GuavaCZ/filament-knowledge-base/issues/new?template=bug.yml).
...
2. Your panel and plugin configuration, or at least the parts you are having trouble with
3. What you expected to happen, and what happened instead
4. The full exception and stack trace, if there is one

> [!NOTE]
> The more of your setup you share, the faster we can reproduce it. A lot of issues turn out to be a missing custom theme, missing assets or a stale cache, so please double check the [installation](02-installation.md) page and run `php artisan cache:clear` first.

## Requesting a feature

Feature requests are handled as [discussions](https://github.com/GuavaCZ/filament-knowledge-base/discussions/new?category=ideas) instead of issues, so other users can chime in and tell us whether they need it too.
...
If something is unclear and you are not sure it's a bug, please use the [Q&A discussions](https://github.com/GuavaCZ/filament-knowledge-base/discussions/new?category=q-a).

## Reporting a security issue

Please do **not** open a public issue for security problems.

If you discover a security related issue, send an email to office@guava.cz instead. More details in our [security policy](https://github.com/GuavaCZ/filament-knowledge-base/security/policy).
